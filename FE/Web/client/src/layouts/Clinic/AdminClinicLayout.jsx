...
import { Avatar, Badge, Button, Empty, Form, List, Popover, Select, Tag, Typography, message } from 'antd'
...
const CLINIC_NOTIFICATION_READ_STORAGE_KEY = 'clinic_layout_notification_read_ids'
...
const buildMockClinicNotifications = (clinicName) => {
  ...
  return [
    ...
    },
    {
      ...
      description: 'Lê Thu Hằng đã đổi lịch cho bé Bông từ 14:00 sang 15:30, dịch vụ Tiêm phòng nhắc lại.',
    },
    {
      id: 'clinic-notify-03',
      type: 'payment',
      ...
      description: 'Hóa đơn MR-2308 cho lịch khám của bé Cún đã được thanh toán online đầy đủ.',
    },
    {
      id: 'clinic-notify-04',
      type: 'review',
      ...
      description: 'Khách hàng Phạm Hải Đăng để lại phản hồi tốt về dịch vụ Khám da liễu cho thú cưng.',
    },
    {
      id: 'clinic-notify-05',
      type: 'system',
      ...
      description: 'Bạn có 7 lịch hẹn vào ngày mai. Hãy xác nhận đủ bác sĩ trực để tránh quá tải.',
    },
  ]
}
...
export default function AdminClinicLayout() {
  ...
  useEffect(() => {
    const storageKey = `${CLINIC_NOTIFICATION_READ_STORAGE_KEY}:${notificationScopeKey}`
    window.localStorage.setItem(storageKey, JSON.stringify(notificationReadIds.slice(-300)))
