...
const NOTIFICATION_LIKE_SNAPSHOT_STORAGE_KEY =
  "client_header_notification_like_snapshot";
...
function Header() {
  ...
  const persistLikeSnapshot = useCallback(
    (snapshot) => {
      ...
      const key = getScopedStorageKey(
        NOTIFICATION_LIKE_SNAPSHOT_STORAGE_KEY,
        currentUserId,
      );
  ...
  useEffect(() => {
    ...
    const readKey = getScopedStorageKey(
      NOTIFICATION_READ_STORAGE_KEY,
      currentUserId,
    );
    const likeSnapshotKey = getScopedStorageKey(
      NOTIFICATION_LIKE_SNAPSHOT_STORAGE_KEY,
      currentUserId,
    );
    ...
    likeSnapshotRef.current =
      storedLikeSnapshot && typeof storedLikeSnapshot === "object"
        ? storedLikeSnapshot
        : {};
