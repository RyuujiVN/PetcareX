...
import {
  getAuthPortalByRole,
  getPostLoginPathByRole,
} from "../../../../constants/authRole";
...
import {
  ...
  isFirebaseGoogleAuthReady,
} from "../../../../data/client/utils/firebaseClient";
      ...
      >
        ...
        <div style={{ textAlign: "center", marginTop: "16px" }}>
          <Text type="secondary">
            Chưa có tài khoản?{" "}
            <a
              style={{ color: "var(--auth-primary)", fontWeight: "bold" }}
              href="/register"
            >
              Đăng ký ngay
            </a>
