...
export default function HomePageClinic() {
  ...
  const posts = [
    { id: 1, image: "/forum1.png", title: 'Thảo luận sốt mũi ở chó' },
    { id: 2, image: "/forum2.png", title: 'Cách chăm sóc mèo mới sinh' },
    { id: 3, image: "/forum3.png", title: 'Làm sao khi mèo bỏ ăn?' }
  ];

  const avatars = [
    { id: 1, image: '/bs1.png', name: 'BS. Tuấn Minh' },
    { id: 2, image: '/bs2.png', name: 'BS. Phương Lan' },
    { id: 3, image: '/bs3.png', name: 'BS. Huy Hoàng' },
      ...
      <section className="services-section">
        <div className="section-container services-layout">
          ...
          <div className="services-center-image">
            <img src="/pageMainClinic.png" alt="pet" />
          </div>
