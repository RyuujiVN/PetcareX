...
export const SERVICE_TO_SPECIALTY_MAP = {
  PERIODIC_HEALTH_CHECK: 'GENERAL_EXAMINATION',
  MEDICAL_EXAMINATION: 'INTERNAL_MEDICINE',
  VACCINATION: 'VACCINATION_AND_PREVENTION',
  DEWORMING: 'INTERNAL_MEDICINE',
  ULTRASOUND_AND_TEST: 'ULTRASOUND',
  SURGERY: 'SURGERY',
  EMERGENCY: 'INTERNAL_MEDICINE',

  // Compatibility aliases for additional service keys used by other environments.
  GENERAL_HEALTH_CHECK: 'GENERAL_EXAMINATION',
  GENERAL_PRACTICE: 'GENERAL_EXAMINATION',
  DERMATOLOGY: 'INTERNAL_MEDICINE',
  OPHTHALMOLOGY: 'INTERNAL_MEDICINE',
  DENTISTRY: 'INTERNAL_MEDICINE',
