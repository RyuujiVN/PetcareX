...
class _BookingPageState extends State<BookingPage> {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: List.generate(_steps.length, (index) {
          ...
          final isActive =
              index == _currentStep || (_currentStep >= 5 && index == 4);
    ...
    return GridView.count(
      ...
      children: [
        ...
        _petItem(
          1,
          'Mimi',
          'assets/images/meo_anh_long_ngan.png',
          'Mèo Anh lông ngắn',
        ),
        _addNewItem(),
      ],
    ...
    return Column(
      children: List.generate(
        ...
        (i) => _listTile(
          ...
          _selectedClinicIndex,
          (val) => _selectedClinicIndex = val,
    ...
    return Column(
      children: List.generate(
        ...
        (i) => _listTile(
          ...
          _doctors[i],
          "Chuyên khoa thú y",
          _selectedDoctorIndex,
          (val) => _selectedDoctorIndex = val,
  ...
  Widget _buildSuccessView() {
    return Column(
      children: [
        ...
        const SizedBox(height: 16),
        const Text(
          "Vui lòng xuất trình mã QR này tại quầy lễ tân.",
          textAlign: TextAlign.center,
  ...
  Widget _smallRow(IconData i, String t, String v, bool a) => Padding(
    padding: const EdgeInsets.only(bottom: 8),
    child: Row(
      children: [
        Icon(i, color: a ? AppColors.primary : Colors.grey, size: 16),
        ...
        child: ElevatedButton(
          ...
          child: Text(
            ...
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.bold,
              color: _isSuccess ? AppColors.primary : Colors.white,
            ),
          ),
        ),
      ),
