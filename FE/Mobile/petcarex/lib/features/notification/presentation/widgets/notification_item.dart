...
class NotificationItem extends StatelessWidget {
  ...
  Widget _buildIcon() {
    final (
      ...
      'LIKE' => (Icons.favorite_border, AppColors.error, AppColors.errorLight),
      _ => (
  ...
  String _getDescription(AppLocalizations l10n) {
    ...
    return switch (n.type) {
      ...
      'AI_DIAGNOSIS' => l10n.notifAiDiagnosisDesc(n.petName ?? ''),
      'FOLLOW_UP_REMINDER' => l10n.notifFollowUpReminderDesc(
        n.appointmentDate ?? '',
      ),
      'COMMENT' =>
        n.userName != null && n.userName!.trim().isNotEmpty
      ...
      'LIKE' =>
        n.userName != null && n.userName!.trim().isNotEmpty
            ? l10n.notifLikeDescWithUser(n.userName!)
            : l10n.notifLikeDescFallback,
      _ => '',
    };
  }
